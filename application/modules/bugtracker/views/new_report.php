          ...
          <div class="uk-width-3-4@m">
            <div class="uk-card-default myaccount-card uk-margin-small">
              <div class="uk-card-header">
                <div class="uk-grid uk-grid-small">
                  <div class="uk-width-expand@m">
                    <h4 class="uk-h4 uk-text-uppercase uk-text-bold" style="color:orange"><i class="fas fa-bug"></i> <?= $this->lang->line('placeholder_create_bug_report'); ?></h4>
                  </div>
              ...
              <div class="uk-card-body">
                ...
                <div class="uk-margin">
                  <button class="uk-button uk-button-default uk-width-1-1" id="button_report" type="submit" style="color:orange"><i class="fas fa-plus-circle"></i> <?= $this->lang->line('button_create'); ?></button>
                </div>
                <?= form_close(); ?>
              </div>
            </div>
