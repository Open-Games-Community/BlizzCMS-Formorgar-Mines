    ...
    <section class="uk-section uk-section-xsmall main-section" data-uk-height-viewport="expand: true">
      <div class="uk-container">
        <h4 class="uk-h4 uk-text-uppercase uk-text-bold" style="color:orange"><i class="fas fa-fist-raised"></i> <?=$this->lang->line('tab_pvp_statistics');?></h4>
        ...
        <ul class="uk-switcher pvp-statistics uk-margin-small">
          ...
          <li>
            <div class="uk-grid uk-grid-small uk-child-width-1-1 uk-child-width-1-3@m" data-uk-grid>
              <dir>
                <span class="uk-label uk-label-success uk-text-bold" style="color:orange"><?=$this->lang->line('statistics_top_2v2');?></span>
              ...
              <div>
                <span class="uk-label uk-label-warning uk-text-bold" style="color:orange"><?=$this->lang->line('statistics_top_3v3');?></span>
                <div class="uk-overflow-auto uk-margin-small">
                  <table class="uk-table dark-table uk-table-divider uk-table-small">
                    <thead>
                      <tr>
              ...
              <dir>
                <span class="uk-label uk-label-danger uk-text-bold" style="color:orange"><?=$this->lang->line('statistics_top_5v5');?></span>
                <div class="uk-overflow-auto uk-margin-small">
                  <table class="uk-table dark-table uk-table-divider uk-table-small">
                    <thead>
                      <tr>
            ...
            <div class="uk-margin">
              <span class="uk-label uk-text-bold" style="color:orange"><?=$this->lang->line('statistics_top_20');?></span>
              <div class="uk-overflow-auto uk-margin-small">
                <table class="uk-table dark-table uk-table-divider uk-table-small">
                  <thead>
                    <tr>
