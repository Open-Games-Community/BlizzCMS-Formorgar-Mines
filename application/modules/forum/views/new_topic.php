      ...
      <div class="uk-container">
        <div class="uk-card-default myaccount-card uk-margin-small">
          <div class="uk-card-header">
            <div class="uk-grid uk-grid-small">
              <div class="uk-width-expand@m">
                <h4 class="uk-h4 uk-text-bold" style="color:orange"><i class="fas fa-pen-square"></i> <?= $this->lang->line('button_new_topic'); ?></h4>
              </div>
              <div class="uk-width-auto@m">
                <a href="<?= base_url('forum'); ?>" class="uk-button uk-button-default uk-button-small" style="color:orange"><i class="fas fa-arrow-circle-left"></i></a>
              </div>
            </div>
          </div>
          <div class="uk-card-body">
            ...
            <?php endif; ?>
            <div class="uk-margin">
              <button class="uk-button uk-button-default uk-width-1-1" type="submit" id="button_topic" style="color:orange"><i class="fas fa-plus-circle"></i> <?= $this->lang->line('button_create'); ?></button>
            </div>
            <?= form_close(); ?>
          </div>
        </div>
