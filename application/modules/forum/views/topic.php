          ...
          <div class="uk-card-header">
            <div class="uk-grid uk-grid-small" data-uk-grid>
              <div class="uk-width-expand">
                <h4 class="uk-h4 uk-text-bold" style="color:orange"><span uk-icon="icon: comments; ratio: 1.2"></span>&nbsp;<?= $this->forum_model->getTopicRow($idlink, 'title'); ?></h4>
              </div>
          ...
          <div class="uk-card-body">
            <div class="uk-grid uk-grid-small" data-uk-grid>
              <div class="uk-width-1-6@s">
                <div class="Author <?php if($this->wowauth->getRank($this->forum_model->getTopicRow($idlink, 'author')) > 0) echo 'topic-author-staff'; ?> uk-flex uk-flex-center" style="color:orange">
        ...
        <div class="uk-grid uk-grid-small uk-child-width-1-1 uk-margin" data-uk-grid>
          ...
          <div>
            <div class="uk-card uk-card-default uk-card-body">
              <div class="uk-grid uk-grid-small" data-uk-grid>
                <div class="uk-width-1-6@s">
                  <div class="Author <?php if($this->wowauth->getRank($commentss->author) > 0) echo 'topic-author-staff'; ?> uk-flex uk-flex-center" style="color:orange">
                    <div class="topic-author-avatar profile">
          ...
          <div>
            <div class="uk-card uk-card-default uk-card-body">
              <h3 class="uk-h3 uk-text-center" style="color:orange"><span uk-icon="icon: comment; ratio: 1.5"></span> <?= $this->lang->line('forum_comment_header'); ?></h3>
          ...
          <div>
            <div class="uk-card uk-card-default uk-card-body">
              <h3 class="uk-h3 uk-text-center" style="color:orange"><span uk-icon="icon: lock; ratio: 1.5"></span> <?= $this->lang->line('forum_not_authorized'); ?></h3>
              <div class="glass-box-container">
