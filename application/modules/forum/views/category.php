        ...
        <div class="uk-margin-remove-top uk-margin-small-bottom">
          <div class="uk-grid uk-grid-small" data-uk-grid>
            <div class="uk-width-expand">
              <h4 class="uk-h4 uk-text-uppercase uk-text-bold" style="color:orange"> <i class="fas fa-list"></i> <?= $this->forum_model->getForumRow($idlink, 'name'); ?></h4>
            </div>
            <div class="uk-width-auto">
              <?php if($this->wowauth->isLogged()): ?>
              <div class="uk-text-center uk-text-right@s">
                <a style="color:orange" href="<?= base_url('forum/topic/new/'.$idlink); ?>" class="uk-button uk-button-default uk-button-small"><i class="fas fa-pencil-alt"></i> <?= $this->lang->line('button_new_topic'); ?></a>
              </div>
              <?php endif; ?>
            </div>
          </div>
