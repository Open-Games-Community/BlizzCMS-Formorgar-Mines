    ...
    <section class="uk-section uk-section-xsmall main-section" data-uk-height-viewport="expand: true">
      <div class="uk-container">
          ...
          <div class="uk-width-3-4@m">
            ...
            <div class="uk-overflow-auto uk-margin-medium forum-table">
              <table class="uk-table uk-table-hover uk-table-middle">
                <caption uk-toggle="target: #cat-<?= $categorys->id ?>;animation: uk-animation-fade" style="color:orange"><i class="fas fa-bookmark"></i> <?= $categorys->name ?></caption>
          ...
          <div class="uk-width-1-4@m">
            <div class="uk-card uk-card-forum">
              <div class="uk-card-header">
                <h3 class="uk-card-title" style="color:orange"><i class="fas fa-book-open"></i> <?= $this->lang->line('forum_last_activity'); ?></h3>
              </div>
        ...
        <div class="uk-card uk-card-forum uk-margin-small">
          <div class="uk-card-header">
            <h3 class="uk-card-title" style="color:orange"><i class="fas fa-users"></i> <?= $this->lang->line('forum_whos_online'); ?></h3>
          </div>
          <div class="uk-card-body">
