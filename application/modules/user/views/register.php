<aside id="right">
    <section class="uk-section uk-section-xsmall main-section" data-uk-height-viewport="expand: true">
      <div class="uk-container">
        <h4 class="uk-h4 uk-heading-line uk-text-uppercase uk-text-bold uk-margin-small-bottom" style="color:orange"><span><i class="fas fa-user-plus"></i> <?= lang('button_register'); ?></span></h4>
        ...
        <div class="uk-grid uk-grid-small uk-grid-margin-small" data-uk-grid>
          ...
          <div class="uk-width-1-4@m">
            <button class="uk-button uk-button-default uk-width-1-1" id="button_register" type="submit" style="color:orange"><i class="fas fa-user-plus"></i> <?= lang('button_register'); ?></button>
          </div>
        </div>
        <?= form_close(); ?>
      </div>
