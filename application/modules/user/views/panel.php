      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-medium" data-uk-grid>
          ...
          <div class="uk-width-3-4@m">
            <h4 class="uk-h4 uk-text-uppercase uk-text-bold" style="color:orange"><?= $this->lang->line('tab_account'); ?></h4>
            <div class="uk-card-default myaccount-card uk-margin-small">
              <div class="uk-card-header">
                <div class="uk-grid uk-grid-small">
                  <div class="uk-width-expand@m">
                    <h5 class="uk-h5 uk-text-uppercase uk-text-bold" style="color:orange"><i class="fas fa-info-circle"></i> <?= $this->lang->line('panel_account_details'); ?></h5>
                  </div>
                  <div class="uk-width-auto@m">
                    <a href="<?= base_url('settings'); ?>" class="uk-button uk-button-default uk-button-small" style="color:orange"><i class="fas fa-user-edit"></i> <?= $this->lang->line('button_account_settings'); ?></a>
                  </div>
                </div>
              </div>
              <div class="uk-card-body">
                <div class="uk-overflow-auto uk-margin-small">
                  <table class="uk-table uk-table-small">
                    <tbody>
                      <tr>
                        <td class="uk-width-small"><span class="uk-h5 uk-text-bold" style="color:#1e87f0"><?= $this->lang->line('placeholder_username'); ?></span></td>
                        <td class="uk-table-expand" style="color:lime"><?= $this->wowauth->getUsernameID($this->session->userdata('wow_sess_id')); ?></td>
                      </tr>
                      <tr>
                        <td class="uk-width-small"><span class="uk-h5 uk-text-bold" style="color:#1e87f0"><?= $this->lang->line('placeholder_email'); ?></span></td>
                        <td class="uk-table-expand" style="color:lime"><?= $this->wowauth->getEmailID($this->session->userdata('wow_sess_id')); ?></td>
                      </tr>
                      <tr>
                        <td class="uk-width-small"><span class="uk-h5 uk-text-bold" style="color:#1e87f0"><?= $this->lang->line('panel_last_ip'); ?></span></td>
                        <td class="uk-table-expand" style="color:lime"><?= $this->user_model->getLastIp($this->session->userdata('wow_sess_id')); ?></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <div class="uk-card-default myaccount-card uk-margin-small">
              <div class="uk-card-header">
                <h5 class="uk-h5 uk-text-uppercase uk-text-bold" style="color:orange"><i class="fas fa-users"></i> <?= $this->lang->line('panel_chars_list'); ?></h5>
              </div>
              <div class="uk-card-body">
                <div class="uk-grid uk-child-width-1-1 uk-margin-small" data-uk-grid>
                  ...
                  ?>
                  <div>
                    <h5 class="uk-h5 uk-text-bold" style="color:orange"><i class="fas fa-server"></i> <?= $this->wowrealm->getRealmName($charsMultiRealm->realmID); ?></h5>
