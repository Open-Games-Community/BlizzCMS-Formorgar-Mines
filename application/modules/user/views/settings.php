      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-medium" data-uk-grid>
          ...
          <div class="uk-width-3-4@m">
            <h4 class="uk-h4 uk-text-uppercase uk-text-bold" style="color:orange"><?= $this->lang->line('button_account_settings'); ?></h4>
            ...
            <div class="uk-card-default myaccount-card uk-margin-small">
                ...
                <div class="uk-card-body">
                  ...
                  <div class="uk-margin">
                    <button class="uk-button uk-button-default uk-width-1-1" style="color:#1e87f0"><i class="fas fa-sync"></i> <?= $this->lang->line('button_save_changes'); ?></button>
                  </div>
                  <?= form_close(); ?>
                </div>
            </div>
            <div class="uk-card-default myaccount-card uk-margin-small">
              <div class="uk-card-header">
                <h5 class="uk-h5 uk-text-uppercase uk-text-bold" style="color:orange"><i class="fas fa-envelope"></i> <?= $this->lang->line('panel_change_email'); ?></h5>
              </div>
              <div class="uk-card-body">
            ...
            <div class="uk-card-default myaccount-card uk-margin-small">
              <div class="uk-card-header">
                <h5 class="uk-h5 uk-text-uppercase uk-text-bold" style="color:orange"><i class="fas fa-key"></i> <?= $this->lang->line('panel_change_password'); ?></h5>
              </div>
              <div class="uk-card-body">
            ...
            <div class="uk-card-default myaccount-card uk-margin-small">
              <div class="uk-card-header">
                <h5 class="uk-h5 uk-text-uppercase uk-text-bold" style="color:orange"><i class="fas fa-id-badge"></i> <?= $this->lang->line('button_change_avatar'); ?></h5>
              </div>
              <div class="uk-card-body">
