<aside id="right">
    <section class="uk-section uk-section-xsmall main-section" data-uk-height-viewport="expand: true">
      <div class="uk-container">
        <h4 class="uk-h4 uk-heading-line uk-text-uppercase uk-text-bold uk-margin-small-bottom"><span style="color:white"><i class="fas fa-sign-in-alt"></i> <?= lang('button_login'); ?></span></h4>
        ...
        <div class="uk-grid uk-grid-small uk-grid-margin-small" data-uk-grid>
          <div class="uk-width-1-4@m">
            ...
            <?php endif; ?>
            <a href="<?= base_url('recovery'); ?>" class="uk-button uk-button-text" style="color:white"><i class="fas fa-key"></i> <?= lang('button_forgot_password'); ?></a>
          </div>
          <div class="uk-width-1-2@m"></div>
          <div class="uk-width-1-4@m">
            <button class="uk-button uk-button-default uk-width-1-1" id="button_login" type="submit" style="background:#0e86ca"><i class="fas fa-sign-in-alt"></i> <?= lang('button_login'); ?></button>
          </div>
        </div>
        <?= form_close(); ?>
    </div>
