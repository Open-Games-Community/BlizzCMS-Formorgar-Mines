		...
		<div class="uk-grid uk-grid-medium" data-uk-grid>
			<div class="uk-width-1-1">
				<div class="uk-width-auto">
					<h4 class="uk-h4 uk-text-uppercase uk-text-bold" style="color:orange"><i class="fas fa-download" style="color:orange"></i> Download</h4>
				</div>
											...
											<table class="uk-table uk-table-middle uk-table-divider">
												...
												<tbody>
													...
													<tr>
														...
														<td style="color:#999"><?=$files->fileName?></td>
														<td style="color:#999"><?=$files->weight?></td>
														<td style="color:#999"><?=$files->type?></td>
