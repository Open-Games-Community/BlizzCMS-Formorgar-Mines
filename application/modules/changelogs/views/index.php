      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-medium" data-uk-grid>
          ...
          <div class="uk-width-3-4@m">
            <h4 class="uk-h4 uk-text-uppercase uk-text-bold" style="color:orange"><?= $this->lang->line('tab_changelogs'); ?></h4>
                  ...
                  <div class="uk-card-header">
                    <div class="uk-grid uk-grid-small" data-uk-grid>
                      <div class="uk-width-expand@s">
                        <h5 class="uk-h5 uk-text-bold" style="color:orange"><i class="fas fa-file-alt"></i> <?= $changelogsList->title ?></h5>
                      </div>
