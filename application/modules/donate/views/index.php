      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-medium" data-uk-grid>
          ...
          <div class="uk-width-3-4@m">
             <h4 class="uk-h4 uk-text-uppercase uk-text-bold" style="color:orange"><?=$this->lang->line('tab_donate'); ?></h4>
            ...
            <?php endif; ?>
            <div class="uk-grid-small uk-grid-match uk-child-width-1-1 uk-child-width-1-1@s uk-flex-center" uk-grid>
