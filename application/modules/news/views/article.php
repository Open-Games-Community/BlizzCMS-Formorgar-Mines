        ...
        <div class="uk-grid uk-grid-medium" data-uk-grid>
              ...
              <div class="uk-card-header">
                <div class="uk-grid uk-grid-small" data-uk-grid>
                  <div class="uk-width-expand@s">
                    <h5 class="uk-h5 uk-text-bold" style="color:orange"><i class="fas fa-newspaper"></i> <?= $this->news_model->getNewTitle($idlink); ?></h5>
                  </div>
          ...
          <div class="uk-width-1-1@m">
            <div class="uk-card uk-card-default">
              <div class="uk-card-header">
                <h5 class="uk-h5 uk-text-bold" style="color:orange"><i class="fas fa-list-alt"></i> <?= $this->lang->line('home_latest_news'); ?></h5>
              </div>
              <div class="uk-card-body">
                <ul class="uk-list uk-text-small" style="text-align:center">
