        ...
        <div class="uk-grid uk-grid-medium" data-uk-grid>
          <div class="uk-width-1-4@m">
            <div class="uk-card uk-card-default">
              <div class="uk-card-header">
                <h5 class="uk-h5 uk-text-bold" style="color:orange"><i class="far fa-list-alt"></i> <?= $this->lang->line('store_categories'); ?></h5>
              </div>
          ...
          <div class="uk-width-3-4@m">
            <div class="uk-card uk-card-default uk-card-body">
              <h5 class="uk-h5 uk-text-bold uk-margin-remove-bottom" style="color:orange"><i class="fas fa-tag"></i> <?= $this->store_model->getCategoryName($route); ?></h5>
    ...
    <script type="text/javascript" href="<?= $template['location'].'assets/css/power.js'; ?>" /></script>
	</aside>